    ...
    class LuckyGrid extends Lucky {
        ...
        draw() {
            ...
            this.cells.forEach((prize, cellIndex) => {
                ...
                drawRoundRect(ctx, x, y, width, height, this.getLength(prize.borderRadius ? prize.borderRadius : defaultStyle.borderRadius) * dpr, this.handleBackground(x, y, width, height, prize.background, isActive));
                // 清空阴影
        ...
        getWidth(width, col = 1) {
            ...
            if (isExpectType(width, 'string'))
                return this.changeUnits(width, { denominator: this.cellWidth * col + this.getGutter() * (col - 1) });
            return 0;
        }
        /**
         * 转换并获取高度
        ...
        getHeight(height, row = 1) {
            ...
            if (isExpectType(height, 'string'))
                return this.changeUnits(height, { denominator: this.cellHeight * row + this.getGutter() * (row - 1) });
            return 0;
        }
        /**
         * 获取相对(居中)X坐标
